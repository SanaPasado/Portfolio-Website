...
const TechStack = () => (
  <div className="border-top pt-5 techstack-container">
    <Row className="align-items-center">
      <Col md={6}>
        <h2 className="anton-regular text-uppercase text-white" style={{ fontSize: '70px', textAlign: 'left', marginBottom: 0 }}>
          My
          <br />
          <span style={{ fontSize: '90px', lineHeight: 1 }}>Tech Stack</span>
        </h2>
      </Col>
      <Col md={6}>
