...
function Projects() {
  ...
  return (
    <div>
      <Row>
        <p className='d-flex border-top mb-1 p-4 justify-content-center anton-regular text-uppercase text-white projects-heading' style={{ fontSize: 'clamp(24px, 8vw, 64px)' }}>Projects</p>
              ...
              {projects.map(project => (
                <Col key={project.title } className =''>
                  ...
                  >
                    ...
                    <Card.Body>
                      <Card.Title className='card-title p-1 fw-bold d-flex justify-content-center py-3'>{project.minimalDescription}</Card.Title>
